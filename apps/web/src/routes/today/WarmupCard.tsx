    ...
    <Card data-testid="warmup-card">
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <p className="mt-1 text-[13px] leading-relaxed text-muted">Free recall of your last lesson. Whatever you remember counts as a review; whatever you miss goes first in today's queue.</p>
        </div>
