...
function LessonView({ runner }: { runner: LessonRunner }) {
  ...
  return (
    <Workspace data-testid="lesson-screen" aside={<ConceptContext concept={view.concept} lesson={lesson} phase={state.phase} />} asideLabel={SIDE_PANEL_LABEL} asideTestId="side-panel">
