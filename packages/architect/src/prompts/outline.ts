/* GENERATED by scripts/sync-prompts.mjs from content/prompts/architect-outline.md. Do not edit by hand. */

export const OUTLINE_PROMPT_VERSION = '1.0';

export const OUTLINE_PROMPT = `# Architect: outline stage
