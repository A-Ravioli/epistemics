/* GENERATED by scripts/sync-prompts.mjs from content/prompts/architect-itemcheck.md. Do not edit by hand. */

export const ITEMCHECK_PROMPT_VERSION = '1.0';

export const ITEMCHECK_PROMPT = `# Architect: item self-check stage
