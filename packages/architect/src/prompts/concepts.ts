/* GENERATED by scripts/sync-prompts.mjs from content/prompts/architect-concepts.md. Do not edit by hand. */

export const CONCEPTS_PROMPT_VERSION = '1.0';

export const CONCEPTS_PROMPT = `# Architect: concepts stage
